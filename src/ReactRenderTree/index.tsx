...
export const DefaultComposition: React.FC = () => {
	const titleText = 'Static Module Bundler';
	const titleColor = '#000000';
	const logoColor = '#00bfff';
		...
		<AbsoluteFill className="bg-gray-100 items-center justify-center">
			...
			<div>
				<svg
					...
					viewBox="0 0 51 31"
				>
					<title>Tailwindcss Logo Wave (top)</title>
					<path
				...
				<svg
					...
					viewBox="0 0 51 31"
				>
					<title>Tailwindcss Logo Wave (bottom)</title>
					<path
